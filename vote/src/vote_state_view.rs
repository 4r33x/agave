...
impl VoteStateFrame {
    ...
    const fn votes_frame(&self) -> VotesFrame {
        match &self {
    ...
    const fn root_slot_frame(&self) -> RootSlotFrame {
        match &self {
    ...
    const fn authorized_voters_frame(&self) -> AuthorizedVotersListFrame {
        match &self {
    ...
    const fn epoch_credits_frame(&self) -> EpochCreditsListFrame {
        match &self {
