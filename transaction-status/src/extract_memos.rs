...
// solana_pubkey::Pubkey
pub const fn spl_memo_id_v1() -> Pubkey {
    MEMO_PROGRAM_ID_V1
}

// A helper function to convert spl_memo::id() as spl_sdk::pubkey::Pubkey to
// solana_pubkey::Pubkey
pub const fn spl_memo_id_v3() -> Pubkey {
    MEMO_PROGRAM_ID_V3
}

static MEMO_PROGRAM_ID_V1: Pubkey = Pubkey::new_from_array(spl_memo::v1::id().to_bytes());
static MEMO_PROGRAM_ID_V3: Pubkey = Pubkey::new_from_array(spl_memo::id().to_bytes());
